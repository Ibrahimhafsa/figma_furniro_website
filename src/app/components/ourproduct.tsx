    ...
    <div className="p-6">
      ...
      <div className="grid   sm:grid-cols-2 lg:grid-cols-4 gap-2">
        ...
        <div className=" rounded-lg p-4">
          <img src="/images/product1.jpg" alt="Product 1" className="w-[245px] h-[350px] object-cover" />
        ...
        {/* Product 2 */}
        <div className="rounded-lg p-4 ">
          <img src="/images/product2.jpg" alt="Product 2" className="w-[245px] h-[350px] object-cover" />
        ...
        {/* Product 3 */}
        <div className=" rounded-lg p-4 ">
          <img src="/images/product3.jpg" alt="Product 3" className="w-[245px] h-[350px] object-cover" />
         ...
         {/* Product 4 */}
         <div className=" rounded-lg p-4">
          <img src="/images/product4.jpg" alt="Product 4" className="w-[245px] h-[350px] object-cover" />
        ...
        {/* Product 5 */}
        <div className="rounded-lg p-4">
          <img src="/images/product5.jpg" alt="Product 5" className="w-[245px] h-[350px] object-cover" />
        ...
        {/* Product 6 */}
        <div className=" rounded-lg p-4">
          <img src="/images/product6.jpg" alt="Product 6" className="w-[245px] h-[350px] object-cover" />
        ...
        {/* Product 7 */}
        <div className=" rounded-lg p-4">
          <img src="/images/product7.jpg" alt="Product 7" className="w-[245px] h-[350px] object-cover" />
        ...
        {/* Product 8 */}
        <div className=" rounded-lg p-4">
          <img src="/images/product8.jpg" alt="Product 8" className="w-[245px] h-[350px] object-cover" />
